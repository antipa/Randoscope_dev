...
%for zd = 9
    ...
    params.z_range = 11:70; %Must be even number!! Range of z slices to be solved for. If this is a scalar, 2D. Use this for subsampling z also (e.g. 1:4:... to do every 4th image)
    params.rank = 10;
    ...
    for tiff_slice = 1
        ...
        params.tau1 = .5e-7;   %.000005 works pretty well for v1 camera, .0002 for v2
        tau_iso = (.25e-4);
