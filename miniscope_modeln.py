...
class Model(tf.keras.Model):
    def __init__(self,target_res=0.005,lenslet_CA=0.2,zsampling = 'uniform_random', cross_corr_norm = 'log_sum_exp', aberrations = False,GrinAber=[], zernikes = []):   #'log_sum_exp'
...
#             self.Grin.append(Grinresize)
        ...
        self.fmin = 4.50980392
        self.fmax = 10.0937255
        self.ior = 1.51
        self.lam=510e-6
        ...
        [xpos,ypos, rlist]=poissonsampling_circular(self,position_mode='initial_nano_new',radius_mode='random')
